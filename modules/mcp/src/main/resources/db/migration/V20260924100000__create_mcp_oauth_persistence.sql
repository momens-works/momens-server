-- Spring Authorization Server's standard JDBC schema, owned by :mcp.
-- PostgreSQL adaptations: BLOB columns are TEXT and timestamps are TIMESTAMPTZ.
-- OAuth protocol state is intentionally separate from mcp_grants.
